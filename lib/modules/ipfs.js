...
var IPFS = function () {
    ...
    (0, _createClass3.default)(IPFS, [{
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                return _context.abrupt('return', _context.sent.id);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                return _context2.abrupt('return', dagNode.data);
        ...
        key: 'storeDAGNode',
        value: function () {
            var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(dagNode) {
                var newDagNode;
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 5:
                                return _context4.abrupt('return', utils.getDAGNodeMultihash(newDagNode));
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 6:
                                ...
                                return _context5.abrupt('return', utils.getDAGNodeMultihash(dagNode));
