...
var rating_pb = require('./rating_pb.js');
var signature_pb = require('./signature_pb.js');
var popr_pb = require('./popr_pb.js');
goog.exportSymbol('proto.ReviewRecord', null, global);
goog.exportSymbol('proto.ReviewRecord.Author', null, global);
goog.exportSymbol('proto.ReviewRecord.DetailedReview', null, global);
goog.exportSymbol('proto.ReviewRecord.Location', null, global);
goog.exportSymbol('proto.ReviewRecord.Platform', null, global);
goog.exportSymbol('proto.ReviewRecord.Review', null, global);
goog.exportSymbol('proto.ReviewRecord.Subject', null, global);
goog.exportSymbol('proto.ReviewRecord.Verification', null, global);
goog.exportSymbol('proto.ReviewRecord.Verification.Method', null, global);
goog.exportSymbol('proto.ReviewRecord.Verification.Proof', null, global);
...
proto.ReviewRecord.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    popr: (f = msg.getPopr()) && popr_pb.PoPR.toObject(includeInstance, f),
    ...
    ratingDetails: (f = msg.getRatingDetails()) && rating_pb.Rating.toObject(includeInstance, f),
    ...
    issuerSignature: (f = msg.getIssuerSignature()) && signature_pb.Signature.toObject(includeInstance, f)
  };
...
proto.ReviewRecord.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new popr_pb.PoPR;
      reader.readMessage(value,popr_pb.PoPR.deserializeBinaryFromReader);
      msg.setPopr(value);
      break;
    case 9:
    ...
    case 23:
      ...
      break;
    case 24:
      var value = new rating_pb.Rating;
      reader.readMessage(value,rating_pb.Rating.deserializeBinaryFromReader);
...
proto.ReviewRecord.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      popr_pb.PoPR.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      24,
      f,
      rating_pb.Rating.serializeBinaryToWriter
    );
  }
...
proto.ReviewRecord.DetailedReview.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    rating: (f = msg.getRating()) && rating_pb.Rating.toObject(includeInstance, f),
...
proto.ReviewRecord.DetailedReview.prototype.getRating = function() {
  return /** @type{!proto.Rating} */ (
    jspb.Message.getWrapperField(this, rating_pb.Rating, 3, 1));
};
...
proto.ReviewRecord.Review.toObject = function(includeInstance, msg) {
  var f, obj = {
    datePublished: jspb.Message.getField(msg, 1),
    url: jspb.Message.getField(msg, 2),
 ...
 * @return {number}
 */
proto.ReviewRecord.Review.prototype.getDatePublished = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.ReviewRecord.Review.prototype.setDatePublished = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.ReviewRecord.Review.prototype.clearDatePublished = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.ReviewRecord.Review.prototype.hasDatePublished = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.ReviewRecord.Verification.Proof.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    provider: jspb.Message.getField(msg, 2),
    signature: (f = msg.getSignature()) && signature_pb.Signature.toObject(includeInstance, f)
  };
...
proto.ReviewRecord.Verification.Proof.prototype.getSignature = function() {
  return /** @type{!proto.Signature} */ (
    jspb.Message.getWrapperField(this, signature_pb.Signature, 3, 1));
};
...
proto.ReviewRecord.prototype.getPopr = function() {
  return /** @type{!proto.PoPR} */ (
    jspb.Message.getWrapperField(this, popr_pb.PoPR, 8, 1));
};
...
proto.ReviewRecord.prototype.getRatingDetails = function() {
  return /** @type{!proto.Rating} */ (
    jspb.Message.getWrapperField(this, rating_pb.Rating, 24, 1));
};
...
proto.ReviewRecord.prototype.getIssuerSignature = function() {
  return /** @type{?proto.Signature} */ (
    jspb.Message.getWrapperField(this, signature_pb.Signature, 27));
};
